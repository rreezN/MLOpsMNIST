...
def main(input_filepath, output_filepath):
    ...
    train_images = normalise(
        train_images, train_images.mean(dim=0), train_images.std(dim=0) + 1e-10
    )
    ...
    test_images = normalise(
        test_images, train_images.mean(dim=0), train_images.std(dim=0) + 1e-10
    )
